...
set "SPEC_CHOICE=none"
if "!VAL_DFLASH!"=="1" set "SPEC_CHOICE=dflash"
if "!VAL_MTP!"=="1" if "!SPEC_CHOICE!"=="none" set "SPEC_CHOICE=mtp"
...
echo [%date% %time%] paso15 SPEC=!SPEC_STATUS! SAMPLING=!SAMPLING_ARGS! REASONING=!REASONING_ARGS! >> "%DBGLOG%"

"!BIN_EXE!" -m "!MODEL_PATH!" --flash-attn on -ngl !VAL_NGL! -c !VAL_CTX! -np !VAL_NP! !KV_ARGS! !B_ARGS! !MCP_ARGS! !SPEC_ARGS! !SAMPLING_ARGS! !REASONING_ARGS! --host !L_HOST! --port !REAL_PORT! --jinja
