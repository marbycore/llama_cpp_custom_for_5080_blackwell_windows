...
$chkTavily.Location = New-Object Drawing.Point(350, 175); $chkTavily.AutoSize = $true
...
$lblTavilyKey.Text = if ($TAVILY_KEY_FOUND) { "✅ API KEY: $TAVILY_KEY_SHORT" } else { "⚠️  Sin TAVILY_API_KEY en entorno" }
$lblTavilyKey.ForeColor = if ($TAVILY_KEY_FOUND) { [Drawing.Color]::LimeGreen } else { [Drawing.Color]::OrangeRed }
$lblTavilyKey.Location = New-Object Drawing.Point(350, 192); $lblTavilyKey.AutoSize = $true
$lblTavilyKey.Font = New-Object Drawing.Font("Segoe UI", 8); $pnl.Controls.Add($lblTavilyKey)
